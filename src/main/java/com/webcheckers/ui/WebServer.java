...
import com.webcheckers.ui.replay.GetStopWatchingRoute;
import com.webcheckers.ui.replay.PostNextTurnRoute;
import com.webcheckers.ui.replay.PostPreviousTurnRoute;
...
public class WebServer {
  ...
  public static final String PLAYER_SIGNIN_URL = "/signin";
  public static final String PLAYER_SIGNOUT_URL ="/signout";
  ...
  public static final String REPLAY_LIST_URL = "/replay";
  public static final String REPLAY_URL = "/replay/game";
  public static final String STOP_WATCHING_URL = "/replay/stopWatching";
   ...
   * @param gameCenter
   *    FIXME: The Google JSON parser object used to render Ajax responses.
   *
  ...
  public void initialize() {
    ...
    // Shows player sign-in page.
    get(PLAYER_SIGNIN_URL, new GetSignInRoute(gameCenter, templateEngine));
    // Shows player sign-out page.
    get(PLAYER_SIGNOUT_URL, new GetSignOutRoute( templateEngine));
    // Shows player the game page
    get(GAME_URL, new GetGameRoute(gameCenter, templateEngine));
    get(REPLAY_URL, new com.webcheckers.ui.replay.GetGameRoute(gameCenter, templateEngine));
    get(STOP_WATCHING_URL, new GetStopWatchingRoute(gameCenter, templateEngine));
    get(REPLAY_LIST_URL, new GetReplayMenuRoute(gameCenter, templateEngine));

    post(HOME_URL, new PostSignInRoute(gameCenter, templateEngine));
    post(PLAYER_SIGNIN_URL, new PostSignInRoute(gameCenter, templateEngine));
    post(PLAYER_SIGNOUT_URL, new PostSignOutRoute(gameCenter, templateEngine));
    post(CHECKTURN_URL, new PostCheckTurnRoute(gameCenter, templateEngine));
    post(VALIDATE_MOVE_URL, new PostValidateMoveRoute(gameCenter, templateEngine));
    ...
    post(REPLAY_NEXT_TURN_URL, new PostNextTurnRoute(gameCenter, templateEngine));
    post(REPLAY_PREVIOUS_TURN_URL, new PostPreviousTurnRoute(gameCenter, templateEngine));
